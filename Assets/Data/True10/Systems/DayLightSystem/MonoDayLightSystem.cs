...
namespace True10.DayLightSystem
{
    ...
    {
        [Inject]
        private TurnBasedController turnController;
        ...
        {
            int turnNumber = callback.Number;
        ...
        {
            lightTween?.Complete();//.Kill();
            exposureTween?.Complete();//.Kill();
            desiredLuxValuTween?.Complete();//.Kill();
