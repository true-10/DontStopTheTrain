...
public class TrainManager : MonoBehaviour
{
    ...
    /*
     [SerializeField] private int _fuel; //запас топливо

     [SerializeField] private int _supplies;//запас еды на дорогу
     [SerializeField] private int _workers;//кол-во сотрудников?

     [SerializeField] private int _cargo;//
     [SerializeField] private int _passengers;//
     */
    #endregion
/*
    public Transform tr1Test;
    public Transform tr2Test;
    void AnimTest()
    {
        DOTween.Sequence().Join(tr1Test.DORotate(tr1Test.localEulerAngles + 360f * tr1Test.forward, 1f));
                          //.Join(tr2Test.DORotate(tr2Test.localEulerAngles - 1f* 360f * tr2Test.forward, 1f)).SetLoops(10);
    }
    */
    public void Init()
    {
